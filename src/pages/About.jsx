  ...
  return (
    <section className="space-y-8 rounded-[2rem] border border-card-border bg-cream-alt p-10 shadow-soft">
      <div className="max-w-3xl space-y-4">
        ...
        <h1 className="text-4xl font-semibold tracking-tight text-midnight-navy">Jamaluddin Jamali</h1>
        <p className="text-lg leading-8 text-slate-700">{author.bio}</p>
      </div>
      <div className="grid gap-6 sm:grid-cols-2">
        <div className="rounded-3xl border border-card-border bg-warm-cream p-6">
